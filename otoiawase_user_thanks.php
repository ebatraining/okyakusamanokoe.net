...
$sql = sprintf('INSERT INTO otoiawase_user SET name="%s", name2="%s", pref="%s", address="%s", mail="%s", telban="%s", question="%s"',
...
// 題名
$sbj .= "お客様の声.net（ユーザー様用）でお問い合わせがありました。";
...
<p class="form_yoha">ユーザー様の御請求内容に応じて、ご対応させていただきます。<br />
